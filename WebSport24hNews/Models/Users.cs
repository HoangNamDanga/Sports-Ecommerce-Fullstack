...
[Table("USERS")]
public partial class Users  : WebSport24hNews.HoangNam.Core.Infrastructure.IAggregateRoot
{
    [Key]
    ...
    [InverseProperty("User")]
    public virtual ICollection<UserDepartments> UserDepartments { get; set; } = new List<UserDepartments>();

    [InverseProperty("User")]
    public virtual ICollection<UserInventories> UserInventories { get; set; } = new List<UserInventories>();
}
