...
[Table("BOM_HEADERS")]
public partial class BomHeader  : WebSport24hNews.HoangNam.Core.Infrastructure.IAggregateRoot
{
    [Key]
    ...
    [Column("ATTRIBUTE15", TypeName = "NUMBER")]
    public decimal? Attribute15 { get; set; }
