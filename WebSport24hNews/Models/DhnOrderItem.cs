...
[Table("DHN_ORDER_ITEMS")]
public partial class DhnOrderItem  : WebSport24hNews.HoangNam.Core.Infrastructure.IAggregateRoot
{
    [Key]
    ...
    [Column("VARIANT_ID", TypeName = "NUMBER")]
    public decimal? VariantId { get; set; }

    [Column("QUANTITY", TypeName = "NUMBER")]
    public decimal? Quantity { get; set; }

    [Column("PRICE_PER_ITEM", TypeName = "NUMBER(10,2)")]
